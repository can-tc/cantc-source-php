...
$epdemo = ['M1','F1','M2','F2'];
$surg = ['ttl_thx','completion','hemi','central_nd','lateral_nd','mediastinal_nd'];
$path = ['pcv','pfv','pav','pnv','fcv','fhcv','fnv','pda'];
$tnm_ep = ['t1','t2','t3','t4','tx','t0','N1a','N1b','N1NO','N0','Nx','M1','M0','Mx','I','II','III','IV'];
$years = ['2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010'];
//$sites = ['London','Halifax','Winnipeg','Toronto','Newfoundland','Hamilton','Fredericton'];
$sites = ['London','Halifax','Winnipeg','Toronto','Newfoundland','Hamilton','Fredericton','Montreal'];
//$sites = ['London','Winnipeg'];
...
{
    global $tn,$dose_range,$tnrw,$epdemo,$surg,$path,$tnm_ep;
    $cols_arr = [];
